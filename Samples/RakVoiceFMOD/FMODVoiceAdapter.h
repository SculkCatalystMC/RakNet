...
// If you get:
// Error	1	fatal error C1083: Cannot open include file: 'fmod.hpp':
// No such file or directory
// c:\raknet\samples\rakvoicefmod\fmodvoiceadapter.h	9 It is because this
// project depends on Fmod.  If you don't have FMOD you can't use it.
#include "fmod.hpp"
...
public:
    ...
    /// You must call this method to create the connection between FMOD and
    /// RakVoice.
    ...
    /// You need to call this once in a while, depending on the parameters used.
    /// Ex: call once every 20-30 milliseconds
    void Update();
...
private:
    ...
    //  FMOD releases all his resources at shutdown, so we don't need to do
    //  anything, which
    // cames in handy, as we don't need to worry about when to destroy the
    // singleton.
    ~FMODVoiceAdapter() {};
