...
// Database queries are asynchronous so the results are read in
// Functor::HandleResult. The default implementation passes it to a callback
class DBResultHandler : public LobbyDBCBInterface {
    virtual void CreateUser_CB(CreateUser_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("CreateUser call canceled:\n");
    ...
    virtual void GetUser_CB(GetUser_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetUser call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void UpdateUser_CB(UpdateUser_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("UpdateUser call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void DeleteUser_CB(DeleteUser_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("DeleteUser call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void ChangeUserHandle_CB(ChangeUserHandle_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("ChangeUserHandle call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void AddAccountNote_CB(AddAccountNote_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("AddAccountNote call canceled:\n");
        else if (callResult->userFound == false) {
    ...
    virtual void GetAccountNotes_CB(GetAccountNotes_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetAccountNotes call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
            ...
            if (callResult->accountNotes.Size() > 0) {
                ...
                for (i = 0; i < callResult->accountNotes.Size(); i++) {
                    ...
                    printf(
                        "%i. moderatorUsername=%s\n",
                        i + 1,
                        callResult->accountNotes[i]->moderatorUsername.C_String()
                    );
    ...
    virtual void AddFriend_CB(AddFriend_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("AddFriend call canceled:\n");
        else if (callResult->success == false) {
    ...
    virtual void RemoveFriend_CB(RemoveFriend_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("RemoveFriend call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void GetFriends_CB(GetFriends_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetFriends call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    RemoveFromIgnoreList_CB(RemoveFromIgnoreList_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("RemoveFromIgnoreList call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void GetIgnoreList_CB(GetIgnoreList_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetIgnoreList call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
            ...
            if (callResult->ignoredUsers.Size() > 0) {
                ...
                for (i = 0; i < callResult->ignoredUsers.Size(); i++) {
                    ...
                    printf(
                        "%i. ignoredUser.userHandle=%s\n",
                        i + 1,
                        callResult->ignoredUsers[i]->ignoredUser.handle.C_String()
                    );
                    printf(
                        "%i. creationTime=%s\n",
                        i + 1,
                        EpochTimeToString(callResult->ignoredUsers[i]->creationTime)
                    );
                }
            } else {
    ...
    virtual void SendEmail_CB(SendEmail_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("SendEmail call canceled:\n");
    ...
    virtual void GetEmails_CB(GetEmails_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetEmails_CB call canceled:\n");
        else if (callResult->validParameters == false) {
    ...
    virtual void DeleteEmail_CB(DeleteEmail_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("DeleteEmail_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void UpdateEmailStatus_CB(UpdateEmailStatus_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("UpdateEmailStatus_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    GetHandleFromUserId_CB(GetHandleFromUserId_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetHandleFromUserId_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    GetUserIdFromHandle_CB(GetUserIdFromHandle_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetUserIdFromHandle_CB call canceled.");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    AddDisallowedHandle_CB(AddDisallowedHandle_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("AddDisallowedHandle_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    RemoveDisallowedHandle_CB(RemoveDisallowedHandle_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("RemoveDisallowedHandle_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    IsDisallowedHandle_CB(IsDisallowedHandle_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("IsDisallowedHandle_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    AddToActionHistory_CB(AddToActionHistory_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("AddToActionHistory_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void GetActionHistory_CB(GetActionHistory_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetActionHistory_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void UpdateClanMember_CB(UpdateClanMember_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("UpdateClanMember_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void UpdateClan_CB(UpdateClan_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("UpdateClan_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void CreateClan_CB(CreateClan_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("CreateClan_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
        ...
        } else if (callResult->initialClanData.failureMessage.IsEmpty() == false
                   || callResult->leaderData.failureMessage.IsEmpty() == false) {
    ...
    virtual void ChangeClanHandle_CB(ChangeClanHandle_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("ChangeClanHandle_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void DeleteClan_CB(DeleteClan_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("DeleteClan_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void GetClans_CB(GetClans_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetClans_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
            ...
            if (callResult->clans.Size() > 0) {
                ...
                for (clanIndex = 0; clanIndex < callResult->clans.Size(); clanIndex++) {
                    ...
                    if (clan->requiresInvitationsToJoin) printf("true\n");
                    else printf("false\n");
                    ...
                    for (memberIndex = 0; memberIndex < callResult->clans[clanIndex]->members.Size(); memberIndex++) {
                        ...
                        if (member->mEStatus1 == LobbyDBSpec::CLAN_MEMBER_STATUS_LEADER) printf("<Leader>");
                        else if (member->mEStatus1 == LobbyDBSpec::CLAN_MEMBER_STATUS_SUBLEADER) printf("<Subleader>");
                        else if (member->mEStatus1 == LobbyDBSpec::CLAN_MEMBER_STATUS_MEMBER) printf("<Member>");
    ...
    virtual void AddToClanBoard_CB(AddToClanBoard_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("AddToClanBoard_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void
    RemoveFromClanBoard_CB(RemoveFromClanBoard_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("RemoveFromClanBoard_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
    ...
    virtual void GetClanBoard_CB(GetClanBoard_PostgreSQLImpl* callResult, bool wasCancelled, void* context) {
        if (wasCancelled) printf("GetClanBoard_CB call canceled:\n");
        else if (callResult->dbQuerySuccess == false) {
            ...
            if (callResult->board.Size() > 0) {
                ...
                for (index = 0; index < callResult->board.Size(); index++) {
                    ...
                    printf(
                        "(%i.) Author=%s (ID=%i)\n",
                        index + 1,
                        post->userId.handle.C_String(),
                        post->userId.databaseRowId
                    );
                    printf(
                        "%i %i %i %i:\n",
                        post->integers[0],
...
void main(int argc, char** argv) {
    printf(
        "A sample on using the provided implementation\nof the Lobby Server "
        "specification based on PostgreSQL\n"
    );
    printf(
        "Unlike the other samples, this is a server-only\nprocess so does not "
        "involve networking with RakNet.\n"
    );
    printf(
        "The goal of this class is to allow you to save\nand retrieve users, "
        "emails, and transactions for a lobby service\n"
    );
    printf("Difficulty: Intermediate\n\n");

    // A function thread is class that spawns a thread that operates on functors.
    // A functor is an instance of a class that has two pre-defined functions: One
    // to perform processing, another to get the result. One per application is
    // enough to not block
    RakNet::FunctionThread ft;

    // Start one thread. Starting more than one may be advantageous for multi-core
    // processors. However, in this scenario we are blocking on database calls
    // rather than processing.
    ft.StartThreads(1);

    // The real functionality of the LobbyServer is contained in the functors
    // defined in LobbyDB_PostgreSQL.h/.cpp. However, this class contains some
    // utility functions and members, such as the functionThread and a pointer to
    // the postgreSQL interface.
    LobbyDB_PostgreSQL lobbyServer;

    // LobbyDB_PostgreSQL internally uses a functionThread so that database
    // queries can happen asynchronously, as opposed to blocking and slowing down
    // the game. If you don't assign one it will create one automatically and
    // start it with one thread.
    lobbyServer.AssignFunctionThread(&ft);

    // The default implementation of the functors pass Functor::HandleResult
    // through to a callback, instantiated here. Alternatively, you could derive
    // from the *_PostgreSQLImpl functors found in LobbyDB_PostgreSQL.h/.cpp and
    // override the behavior of Functor::HandleResult
    ...
    while (1) {
        if (kbhit()) {
            ...
            if (ch == '~') break;
                ...
                if (lobbyServer.DestroyLobbyServerTables() == false) printf("%s", lobbyServer.GetLastError());
                else printf("Tables dropped.\n");
            } else if (ch == 'b') {
                if (lobbyServer.CreateLobbyServerTables() == false) printf("%s", lobbyServer.GetLastError());
                else printf("Tables created.\n");
            } else if (ch == 'c') {
                // We could do new and delete, but this ensures the class is allocated
                // and deallocated in the same DLL, should we use one. By default
                // deallocation takes place in HandleResult()
                ...
                printf(
                    "Updates database info for part of all of a user.\nSpecify user "
                    "by ID (faster) or handle (slower).\n"
                );
                ...
                functor->input.passwordRecoveryQuestion =
                    "What is your mom's occupation? (updated)"; // Test ' in a string
                ...
                printf(
                    "Adds a note to a user's account.\nSpecify user by ID (faster) "
                    "or handle (slower).\n"
                );
                ...
                gets(inputStr);
                if (inputStr[0] == 'y') functor->ascendingSort = true;
                else functor->ascendingSort = false;
                ...
                printf(
                    "Adds a user to the ignore list of another user.\nSpecify user "
                    "by ID (faster) or handle (slower).\n"
                );
                ...
                printf(
                    "Stops ignoring a user.\nSpecify user by ID (faster) or handle "
                    "(slower).\n"
                );
                ...
                printf(
                    "Gets the list of ignored users for a user.\nSpecify user by ID "
                    "(faster) or handle (slower).\n"
                );
                ...
                // Emails can be tagged with a status number. Can use for read,
                // priority, etc.
                ...
                printf(
                    "This is found by calling GetEmails and checking "
                ...
                gets(inputStr);
                if (inputStr[0] == '1') functor->mEStatus1 = LobbyDBSpec::CLAN_MEMBER_STATUS_MEMBER;
                else if (inputStr[0] == '2') functor->mEStatus1 = LobbyDBSpec::CLAN_MEMBER_STATUS_REQUESTED_TO_JOIN;
                else if (inputStr[0] == '3') functor->mEStatus1 = LobbyDBSpec::CLAN_MEMBER_STATUS_INVITED_TO_JOIN;
                else functor->mEStatus1 = LobbyDBSpec::CLAN_MEMBER_STATUS_BLACKLISTED;
        ...
        // Causes Functor::HandleResult calls. If this is forgotten you won't get
        // processing result calls.
