...
// You can extend Lobby2 with your own messages, either overriding existing
// messages or adding new ones In both cases, you'll need to create a custom
// class factory to handle this.
