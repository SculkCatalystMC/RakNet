...
const char *data, int dataLength, unsigned connectionSocketIndex=0)=0
...
RakString MiscellaneousTestsTest::GetTestName() { return "MiscellaneousTestsTest"; }
...
MiscellaneousTestsTest::MiscellaneousTestsTest(void) {
    ...
    errorList.Push(
        "The router interface should not be called because no send "
        "has happened yet",
        _FILE_AND_LINE_
    );
