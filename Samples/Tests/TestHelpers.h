 ...
 *
 *  This
 * source code is licensed under the BSD-style license found in the
 *  LICENSE
...
public:
    ...
    static bool
    WaitAndConnectTwoPeersLocally(RakPeerInterface* connector, RakPeerInterface* connectee, int millisecondsToWait);
