...
int main() {
    // The message filter parses all incoming messages and only allows messages of
    // a certain type
    ...
    while (packet) {
        ...
        case ID_USER_PACKET_ENUM:
            ...
            // Switch the sender to group 1 now so that ID_USER_PACKET_ENUM+1 is
            // allowed.
    ...
    printf(
        "We should now NOT get ID_USER_PACKET_ENUM and should get "
