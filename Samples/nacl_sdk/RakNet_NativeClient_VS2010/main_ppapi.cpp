...
public:
    ...
    explicit ConnectivityTestInstance(PP_Instance instance) : pp::Instance(instance) {
        ...
        /*
        RakNet::ConnectionAttemptResult car = rakPeer->Connect("127.0.0.1", 1234,
        "Rumpelstiltskin", (int) strlen("Rumpelstiltskin"));
        RakAssert(car==RakNet::CONNECTION_ATTEMPT_STARTED);
        RakSleep(100);
        RakNet::Packet* p;
        for (p=rakPeer->Receive(); p; rakPeer->DeallocatePacket(p),
        p=rakPeer->Receive())
                {}
                */
    }
...
public:
    ...
    virtual pp::Instance* CreateInstance(PP_Instance instance) { return new ConnectivityTestInstance(instance); }
};
...
Module* CreateModule() { return new ConnectivityTestModule(); }
} // namespace pp
