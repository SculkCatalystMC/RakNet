...
WinPhone8::WinPhone8() : m_windowClosed(false), m_windowVisible(true) {}
...
void WinPhone8::Initialize(CoreApplicationView ^ applicationView) {
    ...
    CoreApplication::Suspending += ref new EventHandler<SuspendingEventArgs ^>(this, &WinPhone8::OnSuspending);

    CoreApplication::Resuming += ref new EventHandler<Platform::Object ^>(this, &WinPhone8::OnResuming);
...
void WinPhone8::SetWindow(CoreWindow ^ window) {
    ...
    window->Closed += ref new TypedEventHandler<CoreWindow ^, CoreWindowEventArgs ^>(this, &WinPhone8::OnWindowClosed);
...
void WinPhone8::OnWindowClosed(CoreWindow ^ sender, CoreWindowEventArgs ^ args) { m_windowClosed = true; }
...
IFrameworkView ^ Direct3DApplicationSource::CreateView() { return ref new WinPhone8(); }
