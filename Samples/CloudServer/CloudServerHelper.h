...
public:
    ...
    virtual bool
    OnReleaseRequest(RakNetGUID clientGuid, SystemAddress clientAddress, DataStructures::List<CloudKey>& cloudKeys);
...
// To use this class without DynDNS, you only need the CloudServer class. and
// CloudServerHelperFilter The only function you need is
// CloudServerHelper::OnPacket() for CloudServerHelper::OnConnectionCountChange
...
struct CloudServerHelper {
    ...
    MessageID    AuthenticateRemoteServerBlocking(
           RakPeerInterface*     rakPeer,
           TwoWayAuthentication* twoWayAuthentication,
