...
/// FileListTransfer::SetupReceive()<BR> is the setID that is allowed.<BR> It's
/// up to you to transmit this value to the other system, along with information
/// indicating what kind of files you want to get.<BR> The other system should
/// then prepare a FileList and call FileListTransfer::Send(), passing the
/// return value of FileListTransfer::SetupReceive()<BR> as the \a setID
/// parameter to FileListTransfer::Send()
...
public:
    ...
    /// \a chunkSize
    /// \param[in] _chunkSize How large of a block of a file to read/send at once.
    /// Large values use more memory but transfer slightly faster.
    void Send(
        FileList*                 fileList,
