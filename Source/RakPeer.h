...
public:
    ...
    /// behind-LAN address. Use a connected system to get their behind-LAN
    /// address. This does not return the port.
    ...
    // remotePortRakNetWasStartedOn_PS3 and extraSocketOptions are from
    // SocketDescriptor when the socket was created bool RunRecvFromOnce(
    // RakNetSocket *s );
    ...
    struct RemoteSystemStruct {
        ...
        RakNet::Time pingAndClockDifferentialWriteIndex;                          /// The index we are writing into
        ...
        RakNet::Time   lastReliableSend; /// When did the last reliable send occur.  Reliable
    ...
    // DS_APR
    // void ProcessChromePacket(RakNetSocket2 *s, const char *buffer, int
