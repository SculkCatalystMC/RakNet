...
public:
    ...
    static RakNetSocket* CreateBoundSocket( RakPeer *peer, unsigned short port, bool blockingSocket, const char
*forceHostAddress, unsigned int sleepOn10048, unsigned int extraSocketOptions, unsigned short socketFamily,
_PP_Instance_ chromeInstance ); #if defined(WINDOWS_STORE_RT) static RakNetSocket* CreateWindowsStore8Socket( RakPeer
*peer, unsigned short port, bool blockingSocket, const char *forceHostAddress, unsigned int sleepOn10048, unsigned int
extraSocketOptions, _PP_Instance_ chromeInstance ); #endif static RakNetSocket* CreateBoundSocket_IPV4( RakPeer *peer,
unsigned short port, bool blockingSocket, const char *forceHostAddress, unsigned int sleepOn10048, unsigned int
extraSocketOptions, _PP_Instance_ chromeInstance ); #if RAKNET_SUPPORT_IPV6==1 static RakNetSocket*
CreateBoundSocket_SupportIPV4And6( RakPeer *peer, unsigned short port, bool blockingSocket, const char
*forceHostAddress, unsigned int sleepOn10048, unsigned int extraSocketOptions, unsigned short socketFamily,
_PP_Instance_ chromeInstance ); #endif static RakNetSocket* CreateBoundSocket_PS3Lobby( unsigned short port, bool
blockingSocket, const char *forceHostAddress, unsigned short socketFamily ); static RakNetSocket*
CreateBoundSocket_PSP2( unsigned short port, bool blockingSocket, const char *forceHostAddress, unsigned short
socketFamily );
    */
...
//	static void RecvFromBlocking_IPV4( RakNetSocket *s, RakPeer *rakPeer, char *dataOut, int *bytesReadOut,
// SystemAddress *systemAddressOut, RakNet::TimeUS *timeRead );
// 	#if RAKNET_SUPPORT_IPV6==1
// 		static void RecvFromBlockingIPV4And6( RakNetSocket *s, RakPeer *rakPeer, char *dataOut, int *bytesReadOut,
// SystemAddress *systemAddressOut, RakNet::TimeUS *timeRead ); 	#endif
//	static void RecvFromBlocking( RakNetSocket *s, RakPeer *rakPeer, char *dataOut, int *bytesReadOut, SystemAddress
//*systemAddressOut, RakNet::TimeUS *timeRead );
#if defined(WINDOWS_STORE_RT)
//	static void RecvFromBlocking_WindowsStore8( RakNetSocket *s, RakPeer *rakPeer, char *dataOut, int *bytesReadOut,
// SystemAddress *systemAddressOut, RakNet::TimeUS *timeRead );
#endif
    ...
    //	static int SendTo( UDPSOCKET s, const char *data, int length, const char ip[ 16 ], unsigned short port, unsigned
    // short remotePortRakNetWasStartedOn_PS3, unsigned int extraSocketOptions, const char *file, const long line );
    ...
    /// \param[in] port The port number to send to.
    /// \return 0 on success, nonzero on failure.
    //	static int SendTo( RakNetSocket *s, const char *data, int length, SystemAddress systemAddress, const char *file,
    // const long line );
    ...
    // 	static int SendTo_360( RakNetSocket *s, const char *data, int length, const char *voiceData, int voiceLength,
    // const SystemAddress &systemAddress ); 	static int SendTo_PC( RakNetSocket *s, const char *data, int length,
    // const SystemAddress &systemAddress, const char *file, const long line ); #if defined(WINDOWS_STORE_RT) 	static
    // int SendTo_WindowsStore8( RakNetSocket *s, const char *data, int length, const SystemAddress &systemAddress,
    // const char *file, const long line ); #endif
    //
