...
// Given an SQL string with variadic arguments, allocate argumentBinary and argumentLengths, and hold the parameters in
// binary format Last 2 parameters are out parameters
