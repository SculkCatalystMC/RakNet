...
/// The TransportInterface will be used to send data between the server and the client.  The connecting client must
...
public:
    ...
    /// \brief Call this with a derivation of TransportInterface so that the console server can send and receive
    /// commands
