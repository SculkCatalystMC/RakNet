...
public:
    ...
    enum SHDataCategory {
        ...
        /// If value at time t does not exist in the other set, linearly extrapolate value for other set based on
        /// nearest two data points longTerm* values are unknown using this method Use to add two graphs together
        DC_CONTINUOUS
    };
...
protected:
    ...
    // 	virtual void OnDirectSocketReceive(const char *data, const BitSize_t bitsUsed, SystemAddress
    // remoteSystemAddress);
