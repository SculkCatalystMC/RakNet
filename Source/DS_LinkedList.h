...
template <class CircularLinkedListType>
inline void
CircularLinkedList<CircularLinkedListType>::Concatenate(const CircularLinkedList<CircularLinkedListType>& L) {
...
CircularLinkedList<CircularLinkedListType>::Mergesort(const CircularLinkedList& L) {
    unsigned int                               counter;
    node*                                      location;
...
template <class CircularLinkedListType>
CircularLinkedList<CircularLinkedListType>
CircularLinkedList<CircularLinkedListType>::Merge(CircularLinkedList L1, CircularLinkedList L2) {
    ...
    if (L1.list_size != 0) X.Concatenate(L1);
...
LinkedList<LinkedListType> LinkedList<LinkedListType>::Merge(LinkedList L1, LinkedList L2) {
    ...
    // Add the remaining list to X
    if (L1.LinkedList_size != 0) X.concatenate(L1);
    else X.concatenate(L2);
