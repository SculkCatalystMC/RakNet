...
#ifdef _WIN32
    [[maybe_unused]] int res = ioctlsocket__(rns2Socket, FIONBIO, &nonblocking);
    RakAssert(res == 0);
...
#endif
RNS2BindResult
RNS2_Berkley::BindSharedIPV4(RNS2_BerkleyBindParameters* bindParameters, const char* file, unsigned int line) {
...
RNS2BindResult
RNS2_Berkley::BindSharedIPV4And6(RNS2_BerkleyBindParameters* bindParameters, const char* file, unsigned int line) {
